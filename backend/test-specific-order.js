...
async function testSpecificOrderCreation() {
  console.log('🧪 Testing Specific Order Creation with Auto-Printing...\n');
  ...
  try {
    ...
    console.log('\n🎉 Specific order creation test completed!');
...
if (require.main === module) {
  testSpecificOrderCreation();
}

module.exports = testSpecificOrderCreation;
